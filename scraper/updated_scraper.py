...
def parse_schedule(raw: str):
    ...
    if len(time_parts) == 2:
        ...
        if end_time.endswith("AM") or end_time.endswith("PM"):
...
def scrape_ku_classes(subject: str,
    ...
    try:
        ...
        if mode:
            Select(driver.find_element(By.ID, "instructionMode")).select_by_value(mode)
...
if __name__ == "__main__":
    scrape_ku_classes("EECS 690 MATH 127", term_value="4259")